...
COPY apps/lafarmer/apps/web/package.json apps/web/package.json
COPY apps/lafarmer/packages/content-client/package.json packages/content-client/package.json
