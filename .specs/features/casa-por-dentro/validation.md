# Registro consolidado de validação: Casa por dentro

Este arquivo preserva duas rodadas de evidência. A revisão independente inicial registrou os limites que existiam naquele momento; a validação runtime posterior cobre parte desses limites, conforme detalhado na segunda seção.
